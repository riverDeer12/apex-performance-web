...
export class BodyMeasurementFormComponent implements OnInit {
    ...
    submit() {
        ...
        this.type == ActionType.Create ? this.createBodyMeasurement() : this.updateBodyMeasurement();
    }
    ...
    private initUpdateForm() {
        this.form = this.formBuilder.group({
            height: [this.bodyMeasurement.height, [Validators.required, Validators.min(0)]],
            weight: [this.bodyMeasurement.weight, [Validators.required, Validators.min(0)]],
            shoulders: [this.bodyMeasurement.shoulders, [Validators.required, Validators.min(0)]],
            chest: [this.bodyMeasurement.chest, [Validators.required, Validators.min(0)]],
            upperArm: [this.bodyMeasurement.upperArm, [Validators.required, Validators.min(0)]],
